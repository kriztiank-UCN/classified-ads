<header>
  <div class="h-[38rem] w-full bg-cover bg-center"
    ...
    <div class="flex h-full w-full items-center justify-center bg-gray-900/40">
      <div class="text-center">
        {{-- SEARCH --}}
        <div class="grid grid-cols-1 gap-6 rounded-lg border border-gray-300 bg-white p-6 shadow-lg">

          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="grid grid-cols-2 gap-2 rounded border border-gray-200 p-2">
              <div class="flex items-center rounded border bg-gray-300 p-2">
                <svg class="mr-2 w-5 fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  width="24" height="24">
                  <path class="heroicon-ui"
                    d="M12 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10zm0-2a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm9 11a1 1 0 0 1-2 0v-2a3 3 0 0 0-3-3H8a3 3 0 0 0-3 3v2a1 1 0 0 1-2 0v-2a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v2z" />
                </svg>
                <input type="text" placeholder="Enter text here..."
                  class="max-w-full bg-gray-300 text-gray-700 focus:outline-none" />
              </div>
              <div class="flex items-center rounded border bg-gray-300 p-2">
                <svg class="mr-2 w-5 fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  width="24" height="24">
          ...
          <div class="flex justify-center"><button
              class="w-1/4 rounded-md border bg-gray-800 p-2 text-white">Search</button></div>
        </div>
      </div>
    </div>
  </div>
